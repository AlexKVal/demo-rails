...
goog.addDependency("../cljs_gravatar/core.js", ['cljs_gravatar.core'], ['goog.crypt', 'cljs.core', 'clojure.string', 'goog.crypt.Md5']);
goog.addDependency("../admin/gravatar.js", ['admin.gravatar'], ['reagent.core', 'cljs.core', 'cljs_gravatar.core']);
goog.addDependency("../admin/core.js", ['admin.core'], ['admin.gravatar', 'reagent.core', 'cljs.core']);
goog.addDependency("../figwheel/connect/build_admin.js", ['figwheel.connect.build_admin'], ['cljs.core', 'figwheel.client', 'figwheel.client.utils', 'admin.core']);
