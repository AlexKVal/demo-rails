class UseNextId < ActiveRecord::Migration[5.0]
  ...
  def up
    ...
    execute <<-SQL.squish
      UPDATE users SET id = id | 98304000000000 WHERE id < 2147483647;
      UPDATE microposts SET id = id | 98304000000000 WHERE id < 2147483647;
      UPDATE microposts SET user_id = user_id | 98304000000000 WHERE user_id < 2147483647;
      UPDATE relationships SET follower_id = follower_id | 98304000000000 WHERE follower_id < 2147483647;
      UPDATE relationships SET followed_id = followed_id | 98304000000000 WHERE followed_id < 2147483647;
    SQL

    # the right way to update ids is:
    # UPDATE users
    # SET id = ((FLOOR(EXTRACT(EPOCH FROM created_at) * 1000) - 1483228800123)::bigint << 13) | (id % 1024)
    # WHERE id < 2147483647;
    # but I need to update foreign keys as well and it makes the task too complex as for this side project
  end
  ...
  def down
    ...
    execute <<-SQL.squish
      UPDATE users SET id = id - 98304000000000 WHERE id < 105144000000000;
      UPDATE microposts SET id = id - 98304000000000 WHERE id < 105144000000000;
      UPDATE microposts SET user_id = user_id - 98304000000000 WHERE user_id < 105144000000000;
      UPDATE relationships SET follower_id = follower_id - 98304000000000 WHERE follower_id < 105144000000000;
      UPDATE relationships SET followed_id = followed_id - 98304000000000 WHERE followed_id < 105144000000000;
    SQL
  end
end
